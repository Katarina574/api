 ...
 * ```php
 * use Phalcon\Filter\Validation;
 * use Phalcon\Filter\Validation\Validator\FileModel.php\Resolution\Min;
 *
...
{
    protected $template = 'FileModel.php :field can not have the minimum resolution of :resolution';
