 ...
 * ```php
 * use Phalcon\Filter\Validation;
 * use Phalcon\Filter\Validation\Validator\FileModel.php\Resolution\Max;
 *
...
{
    protected $template = 'FileModel.php :field exceeds the maximum resolution of :resolution';
