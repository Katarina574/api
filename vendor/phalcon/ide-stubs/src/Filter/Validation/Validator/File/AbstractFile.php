 ...
 * ```php
 * use Phalcon\Filter\Validation;
 * use Phalcon\Filter\Validation\Validator\FileModel.php\Size;
 *
...
abstract class AbstractFile extends AbstractValidator
{
    ...
    /**
     * FileModel.php exceeds the file size set in PHP configuration
     *
     * @var string
     */
    protected $messageIniSize = 'FileModel.php :field exceeds the maximum file size';

    /**
     * FileModel.php is not valid
     *
     * @var string
     */
